...
public class MemberManagementDemo {
	...
	// 4. ArrayList에 있는 고객을 출력한다
	// 5. print() 메서드를 호출항 번호를 선택할 수 있게 한다.
	...
	// 1. 수정할 아이디를 입력받는다
	// 2. ArrayList에 있는 고객정보에서 수정할 아이디를 찾아서 있으면서 수정할 이름을 입력받고, ArrayList에 고객정보를
	// 수정한다. 만약 수정할 아이디어가 없으면 "수정할 아이디가 없습니다." 라는 메시지를 출력한다
	...
	// 1. 삭제할 아이디를 입력받는다.
	// 2. ArrayList의 Member 객체중에서 삭제할 아이디를 찾아 있으면 삭제하고 없으면 "삭제할 아이디가 없습니다."라는 메시지를
	// 출력한다.
	// 3. ArrayList에 있는 모든 고객을 출력한다.
	// 4. print()메서드 호출
	// 5. 번호를 선택하세요> 메세지를 출력한 후 키보드 입력 받게 함
	...
	// 1. 검색할 아이디를 입력받는다.
	// 2. ArrayList에 Member 객체중에서 검색할 아이디를 찾아서 있으면 출력하고 없으면 "검색된 결과가 없습니다. " 메세지 출력
	// 3. ArrayList에 있는 모든 고객을 출력한다.
	// 4. print()메서드 호출
	// 5. 번호를 선택하세요> 메세지를 출력한 후 키보드 입력 받게 함
	public void search() {
	...
	public static void main(String[] args) {
		...
		m.print();
		String inputData = m.input("번호를 선택하시오>");
		m.run(inputData);
	}
}